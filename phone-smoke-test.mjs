...
await click('[data-action="call-quick"][data-intent="hold_research"]');
...
assert(await evaluate('document.querySelector("#appScreen").dataset.app === "mail"'), 'Minimising a hall call did not allow cross-app Mail research');
...
await click('[data-action="call-quick"][data-intent="record_result"]');
await click('#systemHome');
await click('#appGrid [data-open-app="tasks"]');
