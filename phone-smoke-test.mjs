...
await wait(1600);
assert(await evaluate('document.querySelector(".call-dialogue").textContent.includes("宿舍收發室")'), 'Official hall call did not connect to a call dialogue');
...
await wait(1600);
assert(await evaluate('document.querySelector(".call-dialogue").textContent.includes("Department General Office")'), 'Department call did not connect to a dialogue');
