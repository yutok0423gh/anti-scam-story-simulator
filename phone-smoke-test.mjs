...
await wait(1600);
assert(await evaluate('document.querySelector(".call-dialogue").textContent === "「喂，你好。請問你想查咩？」"'), 'Hall call greeting disclosed or implied an official identity');
...
await click('[data-action="call-hall-ask-identity"]');
assert(await evaluate('document.querySelector(".call-dialogue").textContent.includes("宿舍收發室")'), 'Hall identity claim was not available after the player asked');
...
await click('[data-action="call-hall-describe-request"]');
await click('[data-action="call-hall-share-partial"]');
await click('[data-action="call-hall-provide-tracking"]');
...
await wait(1600);
assert(await evaluate('document.querySelector(".call-dialogue").textContent === "「喂，你好。請問你想搵邊位？」"'), 'Department greeting disclosed or implied an official identity');
...
await click('[data-action="call-department-ask-identity"]');
assert(await evaluate('document.querySelector(".call-dialogue").textContent.includes("Department General Office")'), 'Department identity claim was not available after the player asked');
...
await click('[data-action="call-department-describe-request"]');
await click('[data-action="call-department-ask-research"]');
assert(await evaluate('document.querySelector(".call-dialogue").textContent.includes("冇發出呢封邀請")'), 'Department confirmation did not resolve the research invitation');
await click('[data-action="confirm-department"]');
